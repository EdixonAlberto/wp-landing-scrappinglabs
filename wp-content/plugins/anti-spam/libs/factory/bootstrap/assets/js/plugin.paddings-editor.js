( function( $ ){
    ...
    $.fn.factoryBootstrap461_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap461_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-461 .factory-paddings-editor").factoryBootstrap461_paddingsEditor();
    });
