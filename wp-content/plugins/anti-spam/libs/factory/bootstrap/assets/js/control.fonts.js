...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap461.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap461_fontControl", $.factoryBootstrap461.fontControl );
        $(".factory-bootstrap-461 .factory-font").factoryBootstrap461_fontControl({});
    });
