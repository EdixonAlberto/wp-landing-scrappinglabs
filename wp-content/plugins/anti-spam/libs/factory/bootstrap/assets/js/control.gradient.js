( function( $ ){
    ...
    $.fn.factoryBootstrap461_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap461_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-461 .factory-gradient").factoryBootstrap461_gradientControl();
    });
