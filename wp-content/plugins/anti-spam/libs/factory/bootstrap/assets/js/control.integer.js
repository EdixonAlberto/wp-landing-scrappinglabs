( function( $ ){
    ...
    $.fn.factoryBootstrap461_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap461_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-461 .factory-integer").factoryBootstrap461_integerControl();
    });
